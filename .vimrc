...
if executable('ag')
  let g:ctrlp_user_command = 'ag %s -l --nocolor --ignore-case --ignore-dir venv --ignore-dir vpweb --ignore-dir vptest --ignore-dir cover --ignore-dir media_files --ignore "*.pyc" -g ""'
endif
